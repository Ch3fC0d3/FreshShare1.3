...
const ListingSchema = new Schema({
  ...
  type: { type: String, enum: ['BULK_DROP','NEIGHBOR_SHARE','RECURRING_ESSENTIAL'], required: true },
  ...
  condition: { type: String, enum: ['fresh','frozen','preserved','other'], default: 'fresh' },
  tags: [{ type: String }],
  isOrganic: { type: Boolean, default: false },

  // Pricing and sizing
  price: { type: Number, required: true },             // price per share for BULK_DROP, or per unit for NEIGHBOR_SHARE
  priceUnit: { type: String, enum: ['each','lb','kg','case','share'], default: 'each' },
