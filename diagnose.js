...
req.on('error', (e) => {
  ...
  console.log('SOLUTION: Start the Fastify backend service with the following steps:');
  console.log('1. Create fastify-backend/.env file with:');
  console.log('   PORT=8080');
  console.log('   DATABASE_URL=postgres://localhost:5432/freshshare');
  console.log('2. Run: cd fastify-backend && npm install fastify@4 pg zod dotenv');
