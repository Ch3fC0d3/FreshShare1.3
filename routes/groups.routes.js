...
router.post(
  '/',
  [authJwt.verifyToken, authJwt.isAuthenticated],
  groupController.createGroup
);

// Get all groups
router.get('/', authJwt.optionalAuth, groupController.getAllGroups);

// Get a specific group
router.get('/:id', authJwt.optionalAuth, groupController.getGroupById);
...
// Get shopping list
router.get('/:id/shopping-list', authJwt.optionalAuth, async (req, res) => {
  try {
    const groupId = req.params.id;
