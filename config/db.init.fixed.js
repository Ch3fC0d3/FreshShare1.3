...
// Export the initialization function instead of running it immediately
async function initializeDatabase() {
  try {
    // Clear existing data
    await Promise.all([Group.deleteMany({}), Role.deleteMany({})]);
    ...
    const sampleGroups = [
      {
        ...
        description:
          'A community-driven group focused on bulk buying and sharing local produce.',
        ...
        events: [
          {
            ...
            description:
              'Discussion of upcoming bulk orders and community updates',
      ...
      },
      {
        ...
        description:
          'Community garden group sharing harvests and gardening knowledge.',
